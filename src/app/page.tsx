...
const handleSendEmail = () => {
  window.location.href = 'mailto:omsurvase24@gmail.com';
};
      ...
      <div className="container mx-auto p-2">
        <div className="flex items-center justify-between ml-20 mr-20">
          <div>
            ...
            <Button radius="full" onClick={handleOpenPDF} className="bg-gradient-to-tr from-orange-300 to-orange-500 text-black shadow-lg mt-5 font-bold">
              Resume
            </Button>
            <Button radius="full" onClick={handleSendEmail} className="bg-gradient-to-tr from-orange-300 to-orange-500 text-black shadow-lg mt-5 ml-2 font-bold">
              Contact Me
            </Button>
